...
const GalleryCard = ({countryData ,setData, data}) => {
  ...
  return (
    <>
        ...
        <div className="rounded-lg shadow-xl xl:w-[500px] md:w-[400] bg-white w-[350px] xl:h-[500px] md:h-[400px] h-[350px] m-1 relative  overflow-hidden">
             ...
             <Image src={menu.imageUrl} width={300} height={100} alt={menu.name} onClick={()=> viewImage(menu.imageUrl , i )} className="card-image h-[400px] md:h-[500px] object-cover w-[350px] md:w-[500px] rounded-t-lg"/> <span>{menu.name}</span></div>
             {/* <div className="p-5">
