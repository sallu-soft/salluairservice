...
const Footer = () => {
  return (
    <footer className="bg-[#0f3077] text-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
         ...
         <Image src="/sallu_logo.png" alt="logo" className="bg-white rounded-lg p-2 h-[60px] w-[350px]" height="60" width="350" />
        <span className="self-end text-xs md:text-base">Govt. Approved Travel Agency</span>
    </Link>
              </button>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-300 sm:text-center dark:text-gray-400">© 2025 <button className="hover:underline">SALLU AIR SERVICE</button>. All Rights Reserved.
          </span>
