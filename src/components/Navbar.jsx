...
<nav className={`${navbar? " bg-white":"bg-white text-black"}` + "border-gray-200  bg-white shadow-lg dark:border-gray-700 shadow-gray-800 sticky top-0 z-50"}>
  <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-3">
    ...
    <Link href="/" className="flex items-center flex-col w-fit">
        <Image src="/sallu_logo.png" alt="logo" className="h-[60px] w-[350px]" height="60" width="350" />
